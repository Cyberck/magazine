...
let btn = document.querySelector('.header__btnLeft'),
    list = document.querySelector('.header__navList'),
...
}); // let hoto = document.querySelectorAll('.myBio__photo');
// function fotoAnimate(active) {
//     hoto[active].classList.add('active');
//     hoto.forEach((myBio__photo) => {
//         myBio__photo.addEventListener('click', () => {
//             clearActive()
//             myBio__photo.classList.add('active');
//         })
//     })
// }
// function clearActive() {
//     hoto.forEach((item) => item.classList.remove('active'));
// }
// fotoAnimate(0);
